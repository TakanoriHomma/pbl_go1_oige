...
class GymCommands():
    def __init__(self):
        ...
        self.agent.restore("/home/dogrobot/unitree-a1-ros/catkin_ws/src/unitree_a1_isaac/checkpoints/morita7.pth")
        self.state = None
    ...
    def state_callback(self, msg):
        ...
        if True:
            self.state = np.concatenate([base_acc, base_ang_vel, dof_pos_scaled, dof_vel_scaled, actions])
        elif self.ang_vel and self.base_acc:
