...
params = {
    "config": {
        ...
        "env_info": {
            ...
            "observation_space": spaces.Box(np.ones(27) * -np.Inf, np.ones(27) * np.Inf),
        },
...
class GymCommands():
    def __init__(self):
        ...
        self.agent.restore("/home/dogrobot/unitree-a1-ros/catkin_ws/src/unitree_a1_isaac/checkpoints/naito3_no_acc_obs27.pth")
        self.state = None
    ...
    def state_callback(self, msg):
        ...
        self.state = np.concatenate([base_ang_vel, dof_pos_scaled, dof_vel_scaled])
