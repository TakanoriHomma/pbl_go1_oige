...
class GymCommands():
    def __init__(self):
        ...
        self.agent.restore("/home/rl-dqn/unitree-a1-ros/catkin_ws/src/unitree_a1_isaac/checkpoints/UnitreeTerrainJumpAsym.pth")
        self.state = None
    ...
    def state_callback(self, msg):
        ...
        for i, m in enumerate(msg.motorState[:12]):
            _dof_pos_scaled.append(1.0 * m.q)
        dof_pos_scaled = [] * 12
